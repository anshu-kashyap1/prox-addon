...
(this, function () {
    ...
    var a = new e("English", ["January", "February", "March", "April", "May", "June", "July", "August", "September", "October", "November", "December"], ["Jan", "Feb", "Mar", "Apr", "May", "Jun", "Jul", "Aug", "Sep", "Oct", "Nov", "Dec"], ["Sun", "Mon", "Tue", "Wed", "Thu", "Fri", "Sat"]),
        i = {
            useUtc: !1, getFullYear: function (e) {
                ...
                i = i || a;
                var s = this.getFullYear(e), n = this.getMonth(e) + 1, l = this.getDate(e);
            ...
            return Object.assign({}, i, {useUtc: e})
        }, n = Object.assign({}, i);
    !function () {
    ...
    var l = {
        render: function () {
            ...
            }, [a("span", {class: {"input-group-text": e.bootstrapStyling}}, [a("i", {class: e.calendarButtonIcon}, [e._v(" " + e._s(e.calendarButtonIconContent) + " "), e.calendarButtonIcon ? e._e() : a("span", [e._v("…")])])])]) : e._e(), e._v(" "), a("input", {
                ref: e.refName,
        ...
        data: function () {
            return {input: null, typedDate: !1, utils: s(this.useUtc)}
        },
        computed: {
            formattedValue: function () {
                ...
                return this.bootstrapStyling ? "string" == typeof this.inputClass ? [this.inputClass, "form-control"].join(" ") : Object.assign({}, {"form-control": !0}, this.inputClass) : this.inputClass
            }
        },
        watch: {
    ...
    return function () {
        ...
        staticRenderFns: [],
        components: {DateInput: l, PickerDay: r, PickerMonth: o, PickerYear: d},
        props: {
            value: {
        ...
        data: function () {
            var e = this.openDate ? new Date(this.openDate) : new Date, t = s(this.useUtc);
            return {
